...
const SUDO_PASSWORD = "saymeow2024";
...
function commandHandler(input: string) {
  ...
  switch (input) {
    ...
    case "about":
      ...
      break;
    case "cv":
      writeLines(["Redirecting to sushh.dev...", "<br>"]);
      setTimeout(() => {
        window.open("https://cv.sushh.dev/");
      }, 500);
      break;
    case "projects":
      if (bareMode) {
...
const initEventListeners = () => {
  ...
  console.log(`"%cPassword: saymeow2024"`, "color: red; font-size: 20px;");
};
